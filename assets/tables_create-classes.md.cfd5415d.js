...
<span class="line"><span style="color:#676E95;">//     tr: &#39;new-prefix__head-row&#39;,</span></span>
<span class="line"><span style="color:#676E95;">//     th: &#39;new-prefix__head-cell&#39;,</span></span>
<span class="line"><span style="color:#676E95;">//     thSorted: &#39;new-prefix__head-cell--sorted&#39;,</span></span>
<span class="line"><span style="color:#676E95;">//     thRanked: &#39;new-prefix__head-cell--ranked&#39;</span></span>
<span class="line"><span style="color:#676E95;">//   },</span></span>
<span class="line"><span style="color:#676E95;">//   body: {</span></span>
<span class="line"><span style="color:#676E95;">//     tbody: &#39;new-prefix__body&#39;,</span></span>
<span class="line"><span style="color:#676E95;">//     tr: &#39;new-prefix__body-row&#39;,</span></span>
<span class="line"><span style="color:#676E95;">//     td: &#39;new-prefix__body-cell&#39;,</span></span>
<span class="line"><span style="color:#676E95;">//     tdSorted: &#39;new-prefix__body-cell--sorted&#39;,</span></span>
<span class="line"><span style="color:#676E95;">//     tdRanked: &#39;new-prefix__body-cell--ranked&#39;</span></span>
<span class="line"><span style="color:#676E95;">//   },</span></span>
<span class="line"><span style="color:#676E95;">//   indicator: &#39;new-prefix__indicator&#39;</span></span>
<span class="line"><span style="color:#676E95;">// }</span></span>
<span class="line"></span></code></pre></div><h3 id="function" tabindex="-1">Function <a class="header-anchor" href="#function" aria-hidden="true">#</a></h3><p>A callback function can be provided to <code>createClasses</code>, which accepts a single argument containing the default class names. This allows for the creation of class objects targeting specific elements (e.g. only <code>&lt;table&gt;</code> and <code>&lt;tbody&gt;</code>), rather than every element in the table.</p><div class="language-ts"><button class="copy"></button><span class="lang">ts</span><pre><code><span class="line"><span style="color:#82AAFF;">createClasses</span><span style="color:#A6ACCD;">(</span><span style="color:#89DDFF;">(</span><span style="color:#A6ACCD;">defaults</span><span style="color:#89DDFF;">)</span><span style="color:#A6ACCD;"> </span><span style="color:#C792EA;">=&gt;</span><span style="color:#A6ACCD;"> (</span><span style="color:#89DDFF;">{</span></span>
